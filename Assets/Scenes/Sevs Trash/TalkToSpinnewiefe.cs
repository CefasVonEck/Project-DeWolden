...
public class TalkToSpinnewiefe : MonoBehaviour
{
    // Start is called before the first frame update
    [SerializeField] private NPCConversation spinneConvo;
    ...
    private void Update()
    {
        ...
        if (canStartConversation && Input.GetKeyDown(KeyCode.E))
        {
            ...
            ConversationManager.Instance.StartConversation(spinneConvo);
